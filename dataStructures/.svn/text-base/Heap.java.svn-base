...
import sorting.*;
	...
	public class Heap  {
	   ...
	   */
	  public Heap(Set set, SortTool tool) {
		  count = set.getSize();
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 100; i++) s.insert(new Integer(randGen.nextInt(999)));
		for (int i = 0; i < s.getSize(); ++i) System.out.print(s.get(i) + " ");
		System.out.println();
		Heap h = new Heap(s, new SortToolInteger());
		for (int i = 0; i < 100; ++i) System.out.print(h.nodes[i] + " ");
		System.out.println();
	}
