...
public class ApolloniusSolver {
	 ...
	 * @hops 68
	 */
	public static Circle2d solveApollonius(Circle2d c1, Circle2d c2, Circle2d c3, int s1, int s2, int s3){
		...
		double[] quadSols = algebra.Polynomial.solveQuadraticEquation(a,b,c); //7 Hops
		double rs = quadSols[0];
		double xs = M+N*rs;
		double ys = P+Q*rs;
		//68HOps
		
		return new Circle2d(new Point2d(xs,ys), rs);
	}
