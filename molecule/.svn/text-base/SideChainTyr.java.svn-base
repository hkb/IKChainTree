...
public class SideChainTyr extends SideChain {
	private Carbon   Cb;
	private Carbon   Cg;
	private Carbon   Cd1;
	private Carbon   Cd2;
	...
	Shape3D CzOhBondShape   = null;

	public SideChainTyr(AminoAcid aminoAcid) {
		super(aminoAcid);
		Cb  = new Carbon();
		Cg  = new Carbon();
		Cd1 = new Carbon();;
	...
	public Oxygen   getOh()              { return Oh;  }
	public void     setOh(Oxygen oh)     { Oh = oh;    }
	...
	public BranchGroup getCzOhBond()                     { return CzOhBond; }
	public void    setCzOhBond(BranchGroup CzOhBond)     { this.CzOhBond = CzOhBond; } 
	...
	public Shape3D getCzOhBondShape()                          { return CzOhBondShape; }
	public void    setCzOhBondShape(Shape3D CzOhBondShape)     { this.CzOhBondShape = CzOhBondShape; } 
	...
	public void createBranchGroup(AminoAcid aminoAcid, Shape3D shape, ProteinViewer pV) {	
		...
		Oh.setBranchGroup(pV.addSphere(Oh,   Oxygen.getAtomicRadius()/2, Colors.red));
		...
		setCzOhBond(pV.addBond(Cz, Oh, Colors.black));
		setCzOhBondShape(shape);
	...
	public void reattachBranchGroup(TransformGroup spin) {
		...
		spin.addChild(Oh.getBranchGroup());
	...
	public void draw(J3DScene scene, ChainTree cTree, int i, Carbon Ca) { 
		...
		scene.addShape(new Sphere3d(cTree.getPosition(i, Oh.getPosition().subtract(CaPos)), Oxygen.vdWRadius/2), Color.red);
	}
